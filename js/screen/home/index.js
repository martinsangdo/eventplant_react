			...
			db.transaction(function (txn) {
				...
				txn.executeSql(create_table_sql, [], function(response, error){
									...
									for (var i=0; i<total; i++){
										txn.executeSql('INSERT INTO visitor (num, name, jtype, company, event, department, position, phone, tel, email) VALUES '+
												'(:num, :name, :jtype, :company, :event, :department, :position, :phone, :tel, :email)',
